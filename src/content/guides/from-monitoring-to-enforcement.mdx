...
The other thing enforcement unlocks is the transport layer. With authentication
settled, [MTA-STS](/glossary/mta-sts/) is what stops your mail being read in
transit — and it ramps in stages for the same reasons this did. See
